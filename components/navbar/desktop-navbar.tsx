            ...
            {groupedMenuItems.map((item) => (
              item.children && item.children.length > 0 ? (
                <div key={item.text} className="relative group">
                  ...
                  <div className="absolute left-[30%] top-full mt-2 min-w-[130px] bg-white/50 shadow-[0px_4px_20px_rgba(0,0,0,0.1)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 py-2">
