...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Articles: Schema.Attribute.Component<
      'global.articles-booking-message',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    cookie_consent: Schema.Attribute.Component<'global.cookie-consent', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    ...
    dynamic_zone: Schema.Attribute.DynamicZone<
      [
        ...
        'dynamic-zone.faq',
        'dynamic-zone.reviews',
        'dynamic-zone.blog',
        'dynamic-zone.text-content',
        'dynamic-zone.two-column-intro',
        'dynamic-zone.introduction',
        'dynamic-zone.feature-highlight',
        'dynamic-zone.images-and-text-section',
        'dynamic-zone.video-and-text-section',
        'dynamic-zone.who-i-work-with',
        'dynamic-zone.booking',
        'dynamic-zone.portfolio',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bottom_content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
